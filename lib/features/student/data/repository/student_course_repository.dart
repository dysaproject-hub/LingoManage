...
class StudentCourseRepository {
  ...
  StudentCourseRepository(this._enrollmentDatasources, this._courseDatasources, this._programDatasources);
  ...
  Future<List<StudentCourseData>> getStudentCourseData({
    ...
    for (final enrollment in enrollments) {
      ...
      final programs = await _programDatasources.getProgramById(programId: enrollment.programId);
